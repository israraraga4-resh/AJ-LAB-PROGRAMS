//  2. Develop a Java program for adding elements [Apple, Banana, Orange] into HashSet, TreeSetand LinkedHashSet to perform the following operations directed as followsHashSet Demonstration :HashSet after adding elements: [Apple, Orange, Banana], Size of HashSet:3, Is HashSet empty? false, Contains 'Apple'? true, Contains 'Grape'? False, After removing 'Banana':[Apple, Orange] //
...
public class MapInterfaceDemo {
    public static void main(String[] args) {
        ...
        System.out.println("TreeMap (naturally ordered): " + treeMap);
